// Run: cd apps/web && npx tsx --env-file .env.local scripts/run-sal-celtica.ts
...
async function main() {
  console.log('=== Full Pipeline — Sal Céltica ===\n')
  ...
  if (pErr || !project) {
    console.error('❌ Sal Céltica project not found:', pErr?.message)
    process.exit(1)
  }
